...
class PneumaticMotor extends Motor {
    ...
    PneumaticMotor(String model, long power) { super(model, power); }

    @Override
    public String toString() {
        return "Penumatic motor={model:" + model + ",power:" + power + "}";
    }
}

class HydraulicMotor extends Motor {
    // write your code here ...
    HydraulicMotor(String model, long power) { super(model, power); }
...
class ElectricMotor extends Motor {
    // write your code here ...
    ElectricMotor(String model, long power) { super(model, power); }
...
class WarpDrive extends Motor {
    // write your code here ...
    WarpDrive(String model, long power) { super(model, power); }
